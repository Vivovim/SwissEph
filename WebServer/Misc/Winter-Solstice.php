...
<html lang="en" >
    <head>
        <meta charset="utf-8" />
        <title>Neo Ctopher | December Solstice 2026</title>
...
$query		= "SELECT * FROM winter ORDER BY recid DESC LIMIT 1";
...
<div class="container">
    ...
    <h1 class="About_H1">December Solstice 2026 - Updated Hourly</h1>
